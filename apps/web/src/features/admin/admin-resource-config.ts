...
export const adminResourceConfigs: Record<AdminResourceName, AdminResourceConfig> = {
  ...
  projects: {
    ...
    fields: [
      ...
      { name: 'jointCountry', label: 'Joint Country', type: 'select', options: jointCountryOptions },
      { name: 'departmentId', label: 'Department ID', type: 'text' },
      { name: 'principalInvestigatorId', label: 'Principal investigator ID', type: 'text' },
  ...
  theses: {
    ...
    fields: [
      ...
      { name: 'coSupervisorId', label: 'Co-supervisor ID', type: 'text' },
  ...
  groups: {
    ...
    fields: [
      ...
      { name: 'departmentId', label: 'Department ID', type: 'text' },
      { name: 'facultyId', label: 'Faculty ID', type: 'text' },
      { name: 'leadResearcherId', label: 'Lead researcher ID', type: 'text' },
    ],
    emptyForm: {
      name: '',
      description: '',
